odoo.define('pos_modi.PosModiPaymentScreen', function (require) {
    'use strict';
    ...
    const NumberBuffer = require('pos_modi.NewNumberBuffer');


    // class PosModiNumberBuffer extends NumberBuffer {
    //     constructor() {
    //         super();
    //         console.log("klklkl")
    //         // this.isReset = false;
    ...
    //                     let newkeyvent = keyevent.replace(/[.]/g, '');
    ...
    Registries.Component.extend(PaymentScreen, PosModiPaymentScreen);

    return PosModiPaymentScreen;
});
